...
thumbnail:
  {
    author: Magda Ehlers,
    imageUrl: /images/blog/using-vanilla-extract-with-next-themes/thumbnail.jpg,
    fromUrl: https://www.pexels.com/photo/glowing-pink-jellyfish-2832767/,
    source: Pexels,
  }
isPublished: true
---
...
This guide assumes you’ve installed vanilla-extract according to [the docs](https://vanilla-extract.style/documentation). Start by creating a file `vars.css.ts` in the `/styles` folder that will contain all of the theme setup.

```typescript:vars.css.ts {3,7,9} /space/ showLineNumbers
